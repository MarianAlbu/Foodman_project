...
MODEL_NAME = 'DenseNet169' # Xception, ResNet50, InceptionResNetV2, DenseNet169
VERSION = '02'
USER = 'DBW'
SCALE_WIDTH = 256
SCALE_HIGHT = 192
...
fp_cost = fp * 2500 #245 #FP = modellen sier det er er stein på båndet, men det er det ikke.
fn_cost = fn * 25000 #5292 #FN = stein på båndet som ikke blir oppdaget.
